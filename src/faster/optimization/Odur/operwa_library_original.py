...
# import operwa_library_v2 as version_2
...
def calculate_scale_factor_v1(Inv_1,Inv_2,Q1,Q2):
    """
...
def calculate_scale_factor(Inv_1, Inv_2, Q1, Q2):
    if VERSION == VERSION_ONE:
        return calculate_scale_factor_v1(Inv_1, Inv_2, Q1, Q2)
    else:
        return version_2.calculate_scale_factor(Inv_1, Inv_2, Q1, Q2)
...
## MD- we shall not use this function##
    #assumptions
...
def Join_Calcul(num_WWTP, coordinates):
    ...
    #This calculaes wastewater generation in each sub-catchment##
    ##MD- this is where to get the flow for input as Qinf=flow_wwtp##
    ## MD- NOTE: we use peak to estimate the Qinf##
    ...
    ## MD- We may NOT need this section as onsite sanitation is already factored in the new TT module##
    ...
    # MD- The total_costs_ww will be substituted with the new total cost for treatment train##
    ## Inother words, = sum(ww_pipe_inv_cost +sum(treatment_cost);NOTE, this treatment cost is inclusive of the land cost of wwtp##
